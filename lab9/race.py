...
# IMAGES
img_icon = pygame.image.load('lab9/images/coin.png') # Logo

pygame.display.set_icon(img_icon)

img_road = pygame.image.load('lab9/images/road.png') # Background (Road)
img_player = pygame.image.load('lab9/images/player.png') # Player
img_coin = pygame.image.load('lab9/images/coin.png') # Coin
img_enemy = pygame.image.load('lab9/images/enemycar.png')  # Enemy

# SOUNDS
sound_crash = pygame.mixer.Sound('lab9/sounds/lab9_race_sounds_crash.wav')
sound_crash.set_volume(0.1)

sound_coin = pygame.mixer.Sound('lab9/sounds/lab9_race_sounds_coin.mp3')
sound_coin.set_volume(0.05)

sound_bg = pygame.mixer.Sound('lab9/sounds/lab9_race_sounds_bg.mp3')
...
while running:
    ...
    if not game_over:
        ...
        # Display Score
        font_score = pygame.font.Font("lab9/fonts/VT323-Regular.ttf", 36)
    ...
    # Game Over Screen
        ...
        font_GO = pygame.font.Font("lab9/fonts/VT323-Regular.ttf", 50)
